    ...
    <div style={{ width: 390, minHeight: 1720, background: kiosk.color.paper, color: kiosk.color.ink, fontFamily: kiosk.font.display, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ padding: "18px 16px 28px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <PMobileFold title={t.konto} open={true}>
          ...
          {/* Gefahrenzone collapsed on mobile — one deliberate tap reveals delete */}
          <div style={{ marginTop: 12, borderTop: `1.5px dashed ${kiosk.color.rule}`, padding: "13px 0 2px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer" }}>
            ...
            <span style={{ fontFamily: kiosk.font.mono, fontSize: 11, color: kiosk.color.danger }}>▸</span>
          </div>
        </PMobileFold>
      </div>
