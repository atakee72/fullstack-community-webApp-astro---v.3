...
<div class="space-y-6">
  <div>
    ...
    <p class="text-white/70">Price your item competitively to attract buyers</p>
  </div>
  ...
  <div>
    ...
    <div class="relative">
      ...
      <input
        ...
        class="w-full pl-10 pr-4 py-3 rounded-xl border transition-colors
          {getError('price') ? 'border-red-500 focus:ring-red-500' : 'border-white/15 focus:ring-[#E79750]'}
    ...
    {/if}
    <p class="text-xs text-white/50 mt-1">Min €0.01 - Max €100,000</p>
  </div>

  <!-- Original Price -->
  <div>
    <label for="originalPrice" class="block text-sm font-medium text-white/80 mb-2">
      Original Retail Price <span class="text-white/50">(optional)</span>
    </label>
    <div class="relative">
      <span class="absolute left-4 top-1/2 -translate-y-1/2 text-white/60 text-lg">€</span>
      <input
        ...
        placeholder="0.00"
        class="w-full pl-10 pr-4 py-3 rounded-xl border transition-colors
          {getError('originalPrice') ? 'border-red-500 focus:ring-red-500' : 'border-white/15 focus:ring-[#E79750]'}
          focus:outline-none focus:ring-2 focus:border-transparent"
      />
    </div>
    <p class="text-sm text-white/60 mt-1">Showing the original price helps buyers see the value</p>
