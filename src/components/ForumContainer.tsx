                        ...
                        <div className="p-3 flex flex-col flex-1">
                          ...
                          {Array.isArray(item.tags) && item.tags.length > 0 && (
                            <div className="flex flex-wrap gap-1 pt-2">
                              {item.tags.map((tag) => (
                                <button key={tag} onClick={() => setSearchValue(tag)} className="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-medium bg-[#4b9aaa]/15 border border-[#4b9aaa]/40 text-[#4b9aaa] hover:bg-[#4b9aaa]/25 transition-colors cursor-pointer">{tag}</button>
                              ))}
                            </div>
                          )}
                        </div>
                      ...
                      <div className={cn(
                          ...
                          {Array.isArray(item.tags) && item.tags.length > 0 && (
                            <div className="flex flex-wrap gap-1.5 md:gap-2 pt-4 px-2 md:px-4">
                              {item.tags.map((tag) => (
                                <button key={tag} onClick={() => setSearchValue(tag)} className="inline-flex items-center px-2 md:px-3 py-0.5 md:py-1 rounded-full text-[11px] md:text-xs font-medium bg-[#4b9aaa]/15 border border-[#4b9aaa]/40 text-[#4b9aaa] hover:bg-[#4b9aaa]/25 transition-colors cursor-pointer">{tag}</button>
                              ))}
                            </div>
                          )}
                        </div>
