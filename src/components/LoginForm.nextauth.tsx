...
/**
 * Updated LoginForm component for NextAuth (via auth-astro)
 */
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="email"
                        {...getFieldProps('email')}
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none transition-colors bg-gray-50 ${emailError
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none transition-colors bg-gray-50 ${passwordError
                                ? 'border-red-400 focus:border-red-500'
                                : 'border-gray-200 focus:border-[#4b9aaa]'
                            }`}
