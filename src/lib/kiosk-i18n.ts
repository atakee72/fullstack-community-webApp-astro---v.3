...
const de = {
  ...
  'tour.cal.s2.title': 'Termin anlegen',
  'tour.cal.s2.body': 'Klick auf einen Tag — dort beginnt dein Termin. Ein zweiter Klick auf einen späteren Tag spannt gleich den ganzen Zeitraum auf.',
  'tour.cal.s2.bodyMobile': 'Tipp auf einen Tag — dort beginnt dein Termin. Titel, Zeit, Ort — mehr braucht es fürs Erste nicht.',
  'tour.cal.s3.title': 'Zusagen',
  'tour.cal.s3.body': 'Öffne einen Termin und sag mit einem Klick zu — so sieht der Kiez, wer kommt. Absagen geht genauso leicht.',
  'tour.cal.s4.title': 'Kategorien',
  'tour.cal.s4.body': 'Flohmarkt, Kultur, Sport — die Kategorien filtern den Kalender. Ein Klick an, ein Klick aus — wie im Forum.',
  ...
  'tour.markt.s2.title': 'Anzeige aufgeben',
  'tour.markt.s2.body': 'Deine eigene Anzeige, mit bis zu fünf Fotos. Als Entwurf speichern geht auch — veröffentlicht wird erst, wenn du es sagst.',
  'tour.markt.s3.title': 'Kontakt',
  'tour.markt.s3.body': 'Interesse? Jede Anzeige hat ein Kontaktformular — deine Nachricht geht direkt an die Person. Postfächer gibt es hier nicht.',
  'tour.markt.s4.title': 'Meine Anzeigen',
  'tour.markt.s4.body': 'Deine Anzeigen und Entwürfe an einem Ort — samt Status, auch wenn etwas gerade noch geprüft wird.',
  ...
  'tour.kurier.s2.title': '◈ speichern',
  'tour.kurier.s2.body': 'Das ◈ auf jedem Artikel legt ihn hier ab — lesen, wann du willst. Genau wie im Forum.',
  'tour.kurier.s3.title': 'Gelesenes verblasst',
  'tour.kurier.s3.body': 'Gelesene Artikel verblassen still, Neues bleibt kräftig — ein Blick zeigt, was heute noch wartet.',
  'tour.kurier.s4.title': 'Selbst einreichen',
...
const en: Dict = {
  ...
  'tour.cal.s2.title': 'Create an event',
  'tour.cal.s2.body': 'Click a day — your event starts there. A second click on a later day stretches it into a whole range.',
  'tour.cal.s2.bodyMobile': 'Tap a day — your event starts there. Title, time, place — that’s all it takes to begin.',
  'tour.cal.s3.title': 'RSVP',
  'tour.cal.s3.body': 'Open an event and say you’re coming with one click — the Kiez sees who’ll be there. Changing your mind is just as easy.',
  'tour.cal.s4.title': 'Categories',
  'tour.cal.s4.body': 'Flea market, culture, sports — categories filter the calendar. One click on, one click off — just like the forum.',
  ...
  'tour.markt.s2.title': 'Post a listing',
  'tour.markt.s2.body': 'Your own listing, with up to five photos. Saving it as a draft works too — nothing goes live until you say so.',
  'tour.markt.s3.title': 'Getting in touch',
  'tour.markt.s3.body': 'Interested? Every listing has a contact form — your message goes straight to the person. There are no inboxes here.',
  'tour.markt.s4.title': 'My listings',
  'tour.markt.s4.body': 'Your listings and drafts in one place — status included, even while something is still in review.',
  ...
  'tour.kurier.s2.title': '◈ save',
  'tour.kurier.s2.body': 'The ◈ on any article files it here — read it whenever you like. Just like the forum.',
  'tour.kurier.s3.title': 'Read pieces fade',
  'tour.kurier.s3.body': 'Read articles quietly fade; new ones stay bold — one glance shows what still waits today.',
  'tour.kurier.s4.title': 'Submit your own',
