...
const de = {
  ...
  'market.owner.edit.warningTooltip': 'Bearbeiten gesperrt — diese Anzeige trägt eine Warnung.',
...
const en: Dict = {
  ...
  'market.owner.edit.warningTooltip': 'Editing locked — this listing carries a warning.',
