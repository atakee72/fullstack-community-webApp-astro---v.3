...
const de = {
  ...
  'tour.cal.s4.title': 'Dein Kalender im Kalender',
  'tour.cal.s4.body': 'Zwei Schalter, große Wirkung: ‚Meine Zusagen‘ zeigt nur, wo du zugesagt hast — ‚Gespeichert‘, was du dir gemerkt hast.',
  'tour.cal.s5.title': 'Kategorien',
  'tour.cal.s5.body': 'Flohmarkt, Kultur, Sport — die Kategorien filtern den Kalender. Ein Klick an, ein Klick aus — wie im Forum.',
...
const en: Dict = {
  ...
  'tour.cal.s4.title': 'Your calendar inside the calendar',
  'tour.cal.s4.body': 'Two switches, big effect: ‘My RSVPs’ shows only what you said yes to — ‘Saved’, everything you bookmarked.',
  'tour.cal.s5.title': 'Categories',
  'tour.cal.s5.body': 'Flea market, culture, sports — categories filter the calendar. One click on, one click off — just like the forum.',
